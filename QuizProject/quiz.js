...
// La aplicación tendrá que ser una SPA (single-page application).
// Sólo una pregunta cada vez en pantalla.
...
// Gestión del proyecto desde el inicio en un único repositorio compartido
// (como colaboradores) en Github
...
// FASE 3: Asincronía
// Javascript: Manejo de asincronía. Leer 10 preguntas random de la API de prenguntas
// para generar el Quiz
...
// Mostrar en la Home con una gráfica los resultados de las últimas partidas jugadas
// (leer puntuaciones de LocalStorage). Representar Fecha(eje X) vs Puntuación(eje Y)
